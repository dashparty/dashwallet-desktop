...
# Extract path to dashwallet-desktop source code
...
while true; do
    ...
    case $yn in
        [Yy]* ) yn="Y"
                ...
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:3:CFBundleURLName string Dash" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:3:CFBundleURLSchemes array" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:3:CFBundleURLSchemes:0 string dash" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:4:CFBundleURLName string Dashparty" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:4:CFBundleURLSchemes array" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:4:CFBundleURLSchemes:0 string dashparty" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:5:CFBundleURLName string DashWallet" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:5:CFBundleURLSchemes array" $plist
                /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:5:CFBundleURLSchemes:0 string dashwallet" $plist
                break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes or no.";;
    esac
    ...
    case $yn in
        [Yy]* ) yn="Y"
                ...
                for bits in "${platform[@]}"; do
                    ...
                    cd $base_dir/misc/
                    cp DashWallet.png install.sh DashWallet.desktop /tmp/$app_name/
                    cd /tmp
